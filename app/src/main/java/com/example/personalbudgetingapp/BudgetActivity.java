        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(budgetItem.equals("Select item")){
                    ...
                    String itemNweek = budgetItem+week.getWeeks();
                    String itemNmonth = budgetItem+month.getMonths();

                    Data data = new Data(budgetItem,date,id,itemNday,itemNweek,itemNmonth,Integer.parseInt(budgetAmount),month.getMonths(),week.getWeeks(),null);
    ...
    private void updateData(){
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String itemNweek = item+week.getWeeks();
                String itemNmonth = item+month.getMonths();

                Data data = new Data(item,date,post_key,itemNday,itemNweek,itemNmonth,amount,month.getMonths(),week.getWeeks(),null);
